...
export const metadata: Metadata = generateSEOMetadata({
  title: "Frequently Asked Questions - letslend Finance",
  description:
    "Get answers to common questions about letslend's P2P crypto lending platform. Learn about lending, borrowing, security, fees, and more.",
  canonical: "/faq",
  keywords: [
    "crypto lending FAQ",
...
const faqs = [
  {
    ...
    questions: [
      {
        question: "What is letslend Finance?",
        answer:
          "letslend Finance is a peer-to-peer (P2P) cryptocurrency lending platform built on Somnia L1. It allows users to lend their crypto assets to earn interest or borrow crypto by providing collateral, all through secure smart contracts.",
      },
      {
        question: "How do I get started with letslend?",
        answer:
      ...
      },
      {
        ...
        answer:
          "letslend supports all major Web3 wallets including MetaMask, WalletConnect, Coinbase Wallet, and any wallet compatible with WalletConnect protocol.",
      },
      {
        question: "Do I need to create an account?",
        answer:
          "No, you don't need to create a traditional account. letslend is fully decentralized - you just need to connect your Web3 wallet to start using the platform.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          "Interest rates on letslend are market-driven and can vary based on supply and demand. Lenders typically earn between 5-15% APY, depending on the loan terms, duration, and market conditions.",
      },
      {
        question: "What tokens can I lend?",
        answer:
          "letslend supports a variety of popular cryptocurrencies including stablecoins (USDC, USDT), major tokens (WETH, WBTC), and other selected ERC-20 tokens. The supported token list is regularly updated based on market demand and security assessments.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      {
        question: "How do crypto loans work on letslend?",
        answer:
          "Crypto loans on letslend are collateralized, meaning you must deposit crypto assets as collateral to secure your loan. The collateral value must exceed the loan value by a certain ratio to protect lenders.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      {
        question: "How secure is letslend Finance?",
        answer:
          "letslend prioritizes security with multi-signature wallets, audited smart contracts, and institutional-grade security protocols. All funds are secured by smart contracts, and we never have custody of your assets.",
      },
      {
        question: "Are smart contracts audited?",
        answer:
          "Yes, all letslend smart contracts undergo rigorous security audits by reputable firms. We also implement additional security measures like time-locks and multi-signature requirements for critical functions.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "letslend uses Chainlink price oracles to get real-time, accurate market prices for all supported tokens. This ensures fair and transparent pricing for collateral valuations and liquidations.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        question: "What fees does letslend charge?",
        answer:
          "letslend charges a small platform fee (typically 0.5-1%) on successful loans to maintain and improve the platform. All fees are clearly displayed before you confirm any transaction.",
      },
      {
        question: "Are there any hidden fees?",
        answer:
          "No, letslend believes in complete transparency. All fees, including platform fees and network gas costs, are clearly displayed before you confirm any transaction.",
      },
      {
        question: "How much are gas fees?",
        answer:
          "Gas fees depend on network congestion and are paid to the blockchain network, not letslend. Built on Somnia L1, our platform offers significantly lower gas fees compared to Ethereum mainnet.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "For support, you can reach us through our Discord community, send an email to me, or use the help chat feature on our website.",
      },
      {
        question: "Can I use letslend on mobile?",
        answer:
          "Yes, letslend is fully responsive and works on mobile devices. You can use it through mobile Web3 browsers or wallet apps like MetaMask mobile.",
      },
    ],
  },
];
      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <section className="text-center space-y-6">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Find answers to common questions about letslend &apos; s P2P crypto
        ...
        <section className="text-center space-y-6 py-12 bg-gradient-to-r from-primary/5 to-primary/10 rounded-2xl">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            ...
            team is here to help you get the most out of letslend Finance.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="mailto:fight@letslend.finance"
