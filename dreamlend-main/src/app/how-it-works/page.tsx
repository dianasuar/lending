...
export const metadata: Metadata = generateSEOMetadata({
  title: "How letslend Works - Complete Guide to P2P Crypto Lending",
  description:
    "Learn how letslend's P2P crypto lending platform works. Step-by-step guide to lending, borrowing, earning interest, and managing your crypto loans safely.",
  ...
  const lendingSteps = [
    {
      ...
      description:
        "Connect your Web3 wallet to letslend Finance. We support MetaMask, WalletConnect, and other popular wallets.",
      icon: Wallet,
      color: "text-blue-500",
    },
    {
      ...
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <section className="text-center space-y-6">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Learn how to lend, borrow, and earn with letslend Finance - the
        ...
        <section className="space-y-8">
          <div className="text-center space-y-4">
            <h2 className="text-3xl md:text-4xl font-bold">
              Why Choose letslend Finance
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Advanced features and security measures that make letslend the
