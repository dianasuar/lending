...
const siteConfig = {
  name: "letslend Finance",
  description:
    "The future of decentralized lending. A peer-to-peer lending platform built on Somnia L1.",
  url: process.env.NEXT_PUBLIC_SITE_URL || "https://letslend.finance",
  ogImage: "/og-image.png",
  twitterHandle: "@letslendFi",
  creator: "letslend Team",
};
...
export const generateOrganizationSchema = () => ({
  ...
  sameAs: [
    "https://twitter.com/letslendFi",
    "https://x.com/letslendFi",
    // "https://github.com/letslend",
    // "https://discord.gg/letslend"
  ],
  contactPoint: {
    "@type": "ContactPoint",
    contactType: "Customer Service",
    email: "harsh@letslend.finance",
